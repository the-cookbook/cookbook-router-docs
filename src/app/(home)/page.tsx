          ...
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr]">
            <div className="lg:sticky lg:top-24 lg:self-start">
              ...
              <p className="mt-6 text-lg leading-8 text-fd-muted-foreground">
                ...
                becomes maintenance. Five places to update. Six ways to be
                wrong.
              </p>
        ...
        <section className="border-y bg-fd-card/50">
          <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-fd-muted-foreground">
                The route tree is not a list of screens. It is the contract
                shared by runtime navigation, React rendering, generated types,
                tests, builds, and the server.
              </p>
            </div>
          ...
          <div className="rounded-[2rem] border bg-fd-foreground p-8 text-fd-background md:p-12">
            <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
              ...
              <p className="max-w-2xl text-lg leading-8 opacity-75">
                ...
                separate layer. Generation and build integration stay outside
                the runtime package.
              </p>
            </div>
            ...
            <div className="grid gap-10 p-8 md:p-12 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                ...
                <p className="mt-6 max-w-2xl text-lg leading-8 opacity-80">
                  ...
                  generation when you want typed route IDs, params, search,
                  hash, autocomplete, and build-time validation.
                </p>
              </div>
