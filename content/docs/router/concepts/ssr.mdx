...
description: "Resolve one request with read-only history, map HTTP outcomes, render core or React output, and hydrate safely."
---
...
```tsx ts2js title="src/server.tsx"
