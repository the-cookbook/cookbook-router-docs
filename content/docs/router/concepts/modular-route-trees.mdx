...
```tsx ts2js title="src/features/accounts/account.route.ts"
...
```tsx ts2js title="src/features/accounts/profile.route.ts"
import { defineRoute } from '@cookbook/router';
...
```tsx ts2js title="src/admin/audit/audit.route.ts"
import { defineRoute } from '@cookbook/router';
...
```ts ts2js title="src/routing/search/pagination.ts"
...
```ts ts2js title="src/features/products/product-search.ts"
import { defineSearch } from '@cookbook/router';
...
```tsx ts2js title="src/features/products/products.route.ts"
import {
  defineRoute,
  mergeSearch,
} from '@cookbook/router';
...
```ts ts2js title="src/routing/hash/article-sections.ts"
...
```tsx ts2js title="src/features/articles/article.route.ts"
import { defineRoute } from '@cookbook/router';
...
```tsx ts2js title="src/admin/articles/article-review.route.ts"
import { defineRoute } from '@cookbook/router';
